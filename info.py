...
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/ra9.jpg')
START_IMG = environ.get('START_IMG', 'https://envs.sh/4kh.jpg')
FSUB_PICS = (environ.get('FSUB_PICS', 'https://envs.sh/4kh.jpg')).split() 
...
SECOND_FILES_DATABASE_URL = environ.get('SECOND_FILES_DATABASE_URL', 'mongodb+srv://10xHuB:10xHuB@cluster0.6qfcwqo.mongodb.net/?appName=Cluster0') # 2nd DB For Files
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Clunsjahster0')

# Verify/Shortlink Settings 

IS_VERIFY = is_enabled('IS_VERIFY', False)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003114781601'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003114781601'))
TUTORIAL = environ.get("TUTORIAL", "https://t.me/tenxbackupchannel")
TUTORIAL2 = environ.get("TUTORIAL2", "https://t.me/tenxbackupchannel")
TUTORIAL3 = environ.get("TUTORIAL3", "https://t.me/tenxbackupchannel")
...
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003107393827")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels = environ.get("AUTH_CHANNELS", "-1003107393827")# Channels for force sub (make sure bot is admin)
...
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1003107393827'))
request_channel = environ.get('REQUEST_CHANNEL', '-1003107393827')
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003143993761'))  # Notification of sent to your channel
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003143993761 -1003132672301 -1003430215366').split()] # Auto Index Channel
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1003143993761')) # Channel to delete file from DB
...
TMDB_API_KEY = environ.get('TMDB_API_KEY', 'xxxxxxx') # preffer to use your own tmdb API Key get it from https://www.themoviedb.org/settings/api
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1003114781601") # Channel Where Files sent For stream
if len(BIN_CHANNEL) == 0:
    print('Error BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://cold-paule-prajwalpatil-40ac6133.koyeb.app/") #App URL Where you deployed
if len(URL) == 0:
